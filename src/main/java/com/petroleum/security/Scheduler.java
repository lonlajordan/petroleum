...
public class Scheduler {
    ...
    public void generateTaxReport(){
        ...
        try {
            File outpout = PrintHelper.report(products, start.toLocalDate());
            String attachment = outpout.getAbsolutePath();
            String to = "";
            ...
            String body = "Bonjour, <br>" +
                    ...
                    "Cordialement.";
            EmailHelper.sendMailWithAttachments(to, "", object, body, Collections.singletonList(attachment));
